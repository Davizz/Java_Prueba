...
public class HibernateUtil {
	...
	public static SessionFactory getSessionFactory() {
		...
		/*
		 * El objetivo es la creación de una instancia de sesión. Por lo general, la
		 * aplicación tiene una sola instancia de SessionFactory y las solicitudes de
		 * cliente de servicios de subprocesos obtienen instancias de sesión de esta
		 * fábrica.
		 * 
		...
		if (sessionFactory == null) {
			try {
				...
				settings.put(URL,
						"jdbc:mysql://localhost:3306/hql_libros?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC");
