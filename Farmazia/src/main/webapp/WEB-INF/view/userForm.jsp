			...
			<div class="row mt-4">
				<div class="col-lg-4">
					<fieldset>
						...
						<div class="mb-3">
								<form:label path="username" cssClass="form-label">Nombre Perfil</form:label>
							...
							<div class="mb-3">
								<form:label path="confirmPassword" cssClass="form-label">Repita La Contraseña</form:label>
				...
				<div class="col-lg-8">
					<fieldset>
						...
						<table class="table table-striped">
							<tr>
								<th width="15%">Nombre Perfil</th>
								<th width="15%">Nombre</th>
								<th width="15%">Apellido</th>
								<th width="15%">Email</th>
								<th width="11%">Activado</th>
							...
							<c:if test="${how_many > 0}">
								<c:forEach items="${users}" var="user">
									...
									<tr>
										...
										<td><a href="${role}"
											title="Gestionar Permisos De Usuario ${user.name}">
