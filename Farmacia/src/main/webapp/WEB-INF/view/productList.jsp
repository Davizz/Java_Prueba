					...
					<fieldset>
						...
						<form:form action="save" method="post" modelAttribute="product">
							...
							<div class="mb-3">
								...
								<form:input id="author" path="author" cssClass="form-control" onmouseover="pinta('author')" onmouseout="vuelve('author')"/>
								<form:errors path="author" cssClass="error" />
							</div>

							<div class="mb-3">
								<form:label path="productDetails.publication_year"
									cssClass="form-label">Año de publicación</form:label>
								<form:input id="publication_year" path="productDetails.publication_year"
									cssClass="form-control" onmouseover="pinta('publication_year')" onmouseout="vuelve('publication_year')"/>
								<form:errors path="productDetails.publication_year"
									cssClass="error" />
							</div>

							<div class="mb-3">
								<form:label path="productDetails.purchase_year"
									cssClass="form-label">Año de compra</form:label>
								<form:input id="purchase_year" path="productDetails.purchase_year"
									cssClass="form-control" onmouseover="pinta('purchase_year')" onmouseout="vuelve('purchase_year')"/>
								<form:errors path="productDetails.purchase_year" cssClass="error" />
							</div>

							<div class="mb-3">
								<form:label path="productDetails.page_number" cssClass="form-label">Número de páginas</form:label>
								<form:input id="page_number" path="productDetails.page_number"
									cssClass="form-control" onmouseover="pinta('page_number')" onmouseout="vuelve('page_number')"/>
								<form:errors path="productDetails.page_number" cssClass="error" />
							</div>
					...
					<fieldset>
						...
						<table class="table table-striped">
							<tr>
								...
								<th width="11%">Publicado</th>
								<th width="11%">Comprado</th>
								<th width="11%">Páginas</th>
							...
							<c:if test="${how_many > 0}">
								<c:forEach items="${books}" var="book">
									...
									<tr>
										...
										<td>${product.productDetails.publication_year}</td>
										<td>${product.productDetails.purchase_year}</td>
										<td>${product.productDetails.page_number}</td>
