...
@ComponentScans(value = { @ComponentScan("com.Farmacia.dao"), 
		@ComponentScan("com.Farmacia.service") })
public class AppConfig {
	...
	public LocalSessionFactoryBean getSessionFactory() {
		...
		factoryBean.setAnnotatedClasses(new Class[] {Product.class, ProductDetails.class, Category.class, User.class, });
		//factoryBean.set
