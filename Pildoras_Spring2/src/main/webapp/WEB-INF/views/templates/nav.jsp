		...
		<ul class="nav nav-pills">
			...
			<c:choose>
				<c:when test="${menu == 'index'}">
					<li class="nav-item"><a href="/Fabrica/index"
			...
			<c:choose>
				<c:when test="${menu == 'contacto'}">
					<li class="nav-item"><a href="/Fabrica/contacto"
			...
			<c:choose>
				<c:when test="${menu == 'lista_usuarios'}">
					<li class="nav-item"><a href="/Fabrica/user/list"
...
<c:choose>
				<c:when test="${menu == 'lista_libros'}">
					<li class="nav-item"><a href="/Fabrica/book/list"
