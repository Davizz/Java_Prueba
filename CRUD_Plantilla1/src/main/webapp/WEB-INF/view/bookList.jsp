				...
				<div class="col-4">
					<fieldset>
						...
						<form:form action="save" method="post" modelAttribute="book">
							<div class="mb-3">
								<form:label path="title" cssClass="form-label">Título<span class="asterix">*</span></form:label>
							...
							<div class="mb-3">
								<form:label path="bookDetails.purchase_year" cssClass="form-label">Año de compra</form:label>
