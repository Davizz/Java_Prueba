...
import com.ludo.spring.model.Cliente;
import com.ludo.spring.model.Invernadero;
import com.ludo.spring.model.Planta;
import com.ludo.spring.model.Semilla;
	...
	public static SessionFactory getSessionFactory() {
		...
		if (sessionFactory == null) {
			try {
				...
				settings.put(URL,
						"jdbc:mysql://localhost:3306/form_jardineria?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC");
				...
				MetadataSources sources = new MetadataSources(registry)
						...
						.addAnnotatedClass(Invernadero.class)
						.addAnnotatedClass(Planta.class)
						.addAnnotatedClass(Semilla.class);
