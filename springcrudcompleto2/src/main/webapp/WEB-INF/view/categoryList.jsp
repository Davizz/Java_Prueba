				...
				<div class="col-4">
					<fieldset>
						...
						<form:form action="save" method="post" modelAttribute="category">
							<div class="mb-3">
								<form:label path="category_name" cssClass="form-label">Nombre Categoría</form:label>
								<form:input path="category_name" cssClass="form-control" />
								<form:errors path="category_name" cssClass="error" />
								<form:hidden path="id" />
							</div>
							<button type="submit" class="btn btn-primary"><i class="fas fa-address-card"></i> Crear Categoría</button>
						</form:form>
					</fieldset>
				</div>
				<div class="col-8">
