				...
				<div class="col-4">
					<fieldset>
						...
						<form:form action="save" method="post" modelAttribute="book">
							...
							<div class="mb-3">
								<form:label path="category" cssClass="form-label">Categoría</form:label>
							...
							<div class="mb-3">
								<form:label path="bookDetails.publication_year" cssClass="form-label">Año de Publicación</form:label>
							...
							<div class="mb-3">
								<form:label path="bookDetails.purchase_year" cssClass="form-label">Año de Venta</form:label>
								<form:input path="bookDetails.purchase_year" cssClass="form-control" />
								<form:errors path="bookDetails.purchase_year" cssClass="error" />
							</div>
							<div class="mb-3">
								<form:label path="bookDetails.page_number" cssClass="form-label">Número Páginas</form:label>
								<form:input path="bookDetails.page_number" cssClass="form-control" />
								<form:errors path="bookDetails.page_number" cssClass="error" />
							</div>

							<button type="submit" class="btn btn-primary"><i class="fas fa-address-card"></i> Crear Libro</button>
						</form:form>
					</fieldset>
				</div>
				<div class="col-8">
