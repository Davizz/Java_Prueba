...
public class MainController {
	...
	public ModelAndView index() {
		...
		String msj = "A lo largo de la versión 2.0 del POM, modificaré dicho modelo añadiendo algunas columnas de las que faltan "
				...
				+ "En la versión 2.4, me encargaré de activar el inicio de session en la parte config con Spring Security.<br/><br/>"
				+ "En la versión 2.5, he corregido varios errores como por ejemplo: la relación Many to Many, "
				+ "el usuario que se desactivaba después de hacer un prestamo de libros...";
